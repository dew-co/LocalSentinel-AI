...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = "", variant = "default", size = "default", ...props }, ref) => {
    const variants = {
      default: "bg-cyan-600 text-slate-100 hover:bg-cyan-600/90",
      destructive: "bg-red-900 text-slate-100 hover:bg-red-900/90",
      outline: "border border-slate-700 bg-transparent hover:bg-slate-800 text-slate-100",
      secondary: "bg-slate-800 text-slate-100 hover:bg-slate-800/80",
      ghost: "hover:bg-slate-800 hover:text-slate-100 text-slate-100",
